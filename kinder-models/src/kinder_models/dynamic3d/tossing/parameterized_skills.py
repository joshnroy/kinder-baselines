...
class WindupArmController(MoveArmToConfController):
...
class ReleaseTossController(TossController):
...
class TossFromWindupController(
    ...
    def __init__(
        ...
        super().__init__(*args, **kwargs)
        self._windup_controller = WindupArmController(
            self.objects, pybullet_sim=pybullet_sim
        )
        self._toss_controller = ReleaseTossController(
            self.objects, pybullet_sim=pybullet_sim
        )
        self._last_state: ObjectCentricState | None = None
